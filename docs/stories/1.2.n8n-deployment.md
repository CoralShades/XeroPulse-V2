...
- **Reason:** VPS has 4GB total RAM; n8n shares with other services (Metabase)
...
- n8n will connect to XPM API v3.1 for project management data
...
- Story 1.6: Metabase deployment (also on VPS)
...
| 2025-10-22 | 1.1 | Corrected BI platform references from Superset to Metabase | Sarah (Product Owner) |
